/*    
 *    FilterReadsByCanonNoncanonByReads.cpp		
 *    MapSplice
 *
...
main(int argc, char** argv)
{
	...
	mps_samhandler.FilterCanonNoncaonByReads(mps_sam, filtered_canon, filtered_noncanon, fitlered_noncanon_canon, stat_file, junc_map);
