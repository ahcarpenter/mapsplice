...
main(int argc, char** argv)
{
	...
	int intronlen = atoi(argv[2]);

	int seglen = atoi(argv[3]);
	...
	cout << "number of records filtered: "<< sam_handler.FilterByIntronLenHmer(sam_file, intronlen, seglen)<<endl;
}