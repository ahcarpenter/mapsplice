...
int main(int argc, char* argv[])
{
	...
	string canon_junc = argv[8]; ofstream ofs_canon_junc(canon_junc.c_str());

	string noncanon_junc = argv[9]; ofstream ofs_noncanon_junc(noncanon_junc.c_str());
